...
exports.libraryStatusController = void 0;
const libraryStatus_1 = __importDefault(require("./models/libraryStatus"));
const getAllLibraryStatuses = () => libraryStatus_1.default.findAll();
exports.libraryStatusController = {
    getAllLibraryStatuses: () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            return yield getAllLibraryStatuses();
        }
        catch (err) {
